...
<div class="container">
    ...
    <form action="{{url(action('RegisterController@postRegister'))}}" method="post" class="form-signin">
        ...
        <input type="text" name="nama" class="form-control" placeholder="masukan nama" required autofocus>

        <label for="password" class="sr-only">Password</label>
        <input type="password" name="password" class="form-control" placeholder="masukin password" required>
